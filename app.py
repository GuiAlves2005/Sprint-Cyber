...
# Por simplicidade, manterei a chave aqui, mas com o comentário.
...
def get_user_info(user_id):
    ...
    - CORREÇÃO SAST/SSDLC: A rota espera um inteiro (<int:user_id>),
    ...
    try:
        ...
        # Usa um placeholder (?) e passa o valor em uma tupla.
...
def login():
    ...
    # Lógica de autenticação (apenas simulada)
